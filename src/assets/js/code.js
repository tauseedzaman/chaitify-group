...
channel.bind("messaging", function(data) {
    ...
    playNotificationSound(
        "new_message", !(data.from_id == getMessengerId() && data.to_id == auth_id)
    );
});
...
$(document).ready(function() {
    ...
    function attachmentValidate(file) {
        ...
        if (!chatify.allAllowedExtensions.includes(
    ...
    $("body").on("click", ".create-group-btn", function(e) {
        e.preventDefault();
        app_modal({
            show: true,
            name: "group",
    ...
    // create group button action to show settings modal
