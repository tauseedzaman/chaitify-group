...
Route::get('/join/group={group}', 'MessagesController@join_group')->name('group.join');

/**
 * Fetch messages
 */
Route::post('/fetchMessages', 'MessagesController@fetch')->name('fetch.messages');
Route::get('/get-group-members/{group}', 'MessagesController@listMembers')->name('fetch.members');
...
Route::post('/leaveConversation', 'MessagesController@leaveConversation')->name('conversation.leave');
/**
 * Delete Message
 */
 ...
 * create group
 */
Route::post('/create-group', 'MessagesController@createGroup')->name('group.create');
...
* [Group] view by id
*/
Route::get('/group/{uuid}', 'MessagesController@index')->name('group');
